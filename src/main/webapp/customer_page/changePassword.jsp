                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="password">Currently Password:</label>
                                        <input type="password" required="" class="form-control" id="password"
                                               name="password" placeholder="Enter your old password">
                                    </div>
                                    <div class="form-group">
                                        <label for="passwordNew">Enter new Password</label>
                                        <input type="password" required="" class="form-control" id="passwordNew"
                                               name="passwordNew" placeholder="6 to 35 character">

                                    </div>
                                    <div class="form-group">
                                        <label for="passwordConfirm">Re-enter new Password</label>
                                        <input type="password" required="" class="form-control" id="passwordConfirm"
                                               name="passwordConfirm" placeholder="Re-enter your new Password">
