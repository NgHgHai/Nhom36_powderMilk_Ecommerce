        ...
        <div id="wrapper_container" class="width_common">
            <div id="profile_page" class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 ">
                    <div id="box_chitietdonhang" class="width_common space_bottom_20">
                        <div class="content_box_profile_page order_type_">
                            <div class="block_fillter_donhang space_bottom_20 relative">
                                <div class="tab_fillter_donhang relative width_common space_bottom_20">
                                    <a href="" title="Mua online" class="item_filler_donhang active">Mua online</a>
                                </div>
                                <div id="container-filters">
                                    <div class="tab_sub_fillter_donhang width_common">
                                        <a href="" class="_order_filler_status item_sub_filler_donhang active">Tất cả</a>
                                        <a href="" class="_order_filler_status item_sub_filler_donhang ">Đang xử lý</a>
                                        <a href="" class="_order_filler_status item_sub_filler_donhang ">Đang giao hàng</a>
                                        <a href="" class="_order_filler_status item_sub_filler_donhang ">Thành công</a>
                                        <a href="" class="_order_filler_status item_sub_filler_donhang ">Đã hủy</a>
                                    </div>
                            ...
                            <table class="table caption-top">
                                ...
                                <tr>
                                    ...
                                    <td><a href="#"><span class="txt_color_1">${o.getId()}</span>  </a> </td>
                                    <td><span class="txt_333">${o.getCreateAt()} </span></td>
                                    <td><span class="item_status_order" style="background-color: #4b8c6c">${o.getStatus()}</span></td>
                                    <td><span class="txt_333">Thanh toán khi nhận hàng</span></td>
                                    <td><strong class="txt_color_2">${o.getTotal()}</strong></td>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
            <div class="item_slogan text-center">
                <div><img src="../img/graphics/icon_footer_1.svg" class="loading"
        ...
        <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
            <div class="item_slogan text-center">
                <div><img src="../img/graphics/icon_footer_3.svg" class="loading"
                          data-was-processed="true"></div>
        ...
        <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
            <div class="item_slogan text-center">
                <div><img src="../img/graphics/icon_footer_4.svg" class="loading"
                          data-was-processed="true"></div>
...
<script src="../js/hachamilk-0.1.295.min.js"></script>
