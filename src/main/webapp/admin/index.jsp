      ...
      <div class="card-content">
        <table>
          ...
          <tr>
            ...
            <td data-label="Status" >
              <div class="  status_order green  ">Đã nhận</div>
            </td>
            <td data-label="Created">
          ...
          <tr>
            ...
            <td data-label="Status" >
              <div class="  status_order blue  ">Đang Giao</div>
            </td>
            <td data-label="Created">
...
<footer class="footer">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
    <div class="flex items-center justify-start space-x-3">
      ...
      <div>
        <p>Distributed By: <a href="https://github.com/NgHgHai/Nhom36_powderMilk_Ecommerce" target="_blank">Nhóm 36</a></p>
      </div>
...
<script src="js/chart.sample.js"></script>
