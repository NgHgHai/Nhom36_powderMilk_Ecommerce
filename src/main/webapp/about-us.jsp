            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img position-relative overflow-hidden p-5 pe-0">
                        <img class="img-fluid w-100" src="img/blogPost/about.png">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="display-5 mb-4"><P></P>Rovide the best milk</h1>
                    <p class="mb-4">Baby formula is carefully researched to suit the health and nutritional health of babies in Japan in particular as well as babies in Asia in general.</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Tempor erat elitr rebum at clita</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Easy to absorb</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Lots of nutrients</p>
