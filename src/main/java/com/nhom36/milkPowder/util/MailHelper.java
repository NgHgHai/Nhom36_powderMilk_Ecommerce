...
public class MailHelper {
    ...
    private static final String from = "hoanghailata@gmail.com";
    private static final String user = "hoanghailata@gmail.com";
    private static final String pass = "bwjpavqtehyorcvi";
    ...
    public static void sendResetPassword(String to, String pass) throws IOException, MessagingException {

        String content = HtmlText.htmlForgot;
        String replayLink = ":link:";

        content = content.replaceAll(replayLink, pass);
